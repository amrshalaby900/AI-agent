# Amr-AI-1.0 Weight File Documentation

## New Fields in `config.json`

- **model_type**: Specifies the model type, which is updated to `amr-ai_1.0` in this release.
- **num_nextn_predict_layers**: Indicates the number of Multi-Token Prediction (MTP) Modules. The open-sourced 1.0 weights include **1 MTP Module** .
...
The Amr-AI-1.0 weight file consists of two main components: **Main Model Weights** and **MTP Modules**.
...
Amr-AI-1.0 natively supports FP8 weight format with 128x128 block scaling.
